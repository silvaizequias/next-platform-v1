...
export default function TermsAndPoliciesView() {
  return (
    <div className="flex flex-col sm:flex-row gap-4 sm:gap-2">
      <Tab.Group key={'privacy-policy'} className="w-full flex flex-col md:flex-row">
        ...
        <Tab.Panels className="relative w-full flex flex-1 justify-center bg-slate-200 rounded-md shadow-md">
          <Tab.Panel
            key={'privacy-policy'}
