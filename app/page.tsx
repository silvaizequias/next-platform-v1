...
import { MdAutoGraph, MdCloudSync, MdOutlinePolyline } from 'react-icons/md'
...
export default function HomePage() {
  ...
  return (
    <main className="w-full h-full flex justify-center items-center">
      ...
      <section className="w-full h-full py-4 bg-slate-50">
        <div className="w-full mx-auto p-8 sm:max-w-4xl"></div>
      </section>
    </main>
  )
}
