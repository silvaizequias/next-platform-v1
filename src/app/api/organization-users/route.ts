...
import {
  ...
  OrganizationUserCreateSchemaType,
...
export async function POST(request: Request) {
  try {
    const inputs: OrganizationUserCreateSchemaType = await request.json()
    if (await OrganizationUserCreateSchema.parseAsync(inputs)) {
