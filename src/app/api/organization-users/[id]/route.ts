...
import {
  ...
  OrganizationUserUpdateSchemaType,
...
export async function PATCH(
  ...
  const { id } = params
  try {
    const inputs: OrganizationUserUpdateSchemaType = await request.json()
    if (await OrganizationUserUpdateSchema.parseAsync(inputs)) {
