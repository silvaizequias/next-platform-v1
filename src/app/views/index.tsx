  ...
  return (
    <div className="flex-wrap mx-auto dark:bg-gradient-to-r from-slate-600 to-slate-800">
        ...
        >
          <div className="flex justify-center">
            <div className="p-4">
              ...
              <p className="text-center">
                Torne-se parte da nossa jornada de personalização e experimente
                um suporte que se adapta ao seu negócio.
              </p>
            </div>
          </div>
        </PageSection>
      ...
      <div className="sm:mx-8 mx-2">
        ...
        >
          <div className="flex justify-center">
            <div className="p-4 dark:bg-slate-200 bg-slate-800 text-slate-200 dark:text-slate-800 rounded-md">
      ...
      <div className="sm:mx-8 mx-2">
        <PageSection
          ...
          subtitle="Mantenha os clientes satisffeitos sem perder sua produtividade e lucratividade"
        ...
        >
          <div className="flex justify-center">
            <div className='p-4'>
              <p className="text-justify my-2">
                Personalize seu suporte agora! Entre em contato para uma
                avaliação gratuita e descubra como a DEDICADO pode revolucionar
                o suporte técnico do seu negócio.
              </p>
            </div>
          </div>
        </PageSection>
