        ...
        <div className="z-auto pt-16 h-80 mx-auto relative block backdrop-brightness-50 backdrop-blur-sm">
          <div className="min-h-full px-10 flex flex-col justify-center items-center">
            <div className="mx-auto text-center">
              <h4 className="font-bold text-2xl sm:text-4xl md:text-6xl lowercase tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-light-blue-200">
                {title}
              </h4>
            </div>
            <div className="mx-auto my-6 px-8 sm:px-16 text-center">
              <h6 className="font-semibold text-sm sm:text-base uppercase text-blue-gray-50">
                {subject}
              </h6>
            </div>
          </div>
